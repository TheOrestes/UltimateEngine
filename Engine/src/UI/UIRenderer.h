...
public:
	...
	void Begin();
	void Render(const DXRenderDevice* pDXRenderDevice, ID3D12GraphicsCommandList* pGraphicsCommandList, DirectX::XMFLOAT4& clearColor);
	void End(ID3D12GraphicsCommandList* pGraphicsCommandList);
	void Cleanup();
